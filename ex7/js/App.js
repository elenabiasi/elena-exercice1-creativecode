class App {
    ...
    for (let j = 0; j < 100; j++) {
      for (let i = 0; i < 100; i++) {
        const circle = new Circle(
          top_left.x + i * 20, top_left.y + j * 20, 10, this.ctx
        )
  ...
  draw() {
    ...
    this.grid.forEach((circle, index) => {
      ...
      // this.ctx.font =  this.audio.dataWave[1] + "px" + "Arial";
      // this.ctx.fillText("Hello", this.canvas.width/6, this.canvas.height);  
      // this.ctx.closePath()
